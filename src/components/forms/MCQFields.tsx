...
export const MCQFields = ({
  ...
  const contentErrors = errors.flashcard_content as FieldErrors<
    MCQFormValues["flashcard_content"]
  >
  ...
  return (
    <div className="space-y-2">
      <label className="block font-medium mb-2 text-neutral900">
        Options{" "}
        <span className="text-neutral500 font-normal text-sm">
