...
export function Login(): JSX.Element {
  return (
    <div className="flex items-center justify-center min-h-screen w-full bg-neutral50 p-8">
      <div
        className="flex flex-col border border-neutral100 rounded-12
                w-full max-w-[343px]
                md:max-w-[522px]
                lg:max-w-[540px]
                min-h-[403px]
      ...
      >
        <div className="flex flex-col items-center px-4 md:px-8 pt-10 md:pt-12 pb-8 gap-6">
          ...
          <div className="flex flex-col items-center gap-2">
            <h1 className="text-[24px] md:text-preset2 font-poppins text-neutral900">
              Welcome to Flashcards
            </h1>
            <p className="text-preset5 text-neutral600">
